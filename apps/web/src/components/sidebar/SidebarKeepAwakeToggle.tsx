 ...
 * unattended agent work. Gated on the primary server's platform (not the
...
export function SidebarKeepAwakeToggle() {
  ...
  const tooltip = keepAwake
    ...
    : "Prevent this Mac from sleeping while the T3 Code server is running (uses caffeinate).";
