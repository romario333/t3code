...
// when the user themselves acts on a thread and the screen stays put while
// agents run. Status (including pending approval) is carried by each card's
// edge strip, not by position.
